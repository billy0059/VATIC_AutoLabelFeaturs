...
function Journal(start, blowradius)
{
     ...
     */
    this.markInitial = function(frame, position) 
    {
    ...
    // Implementation
    this.mark = function(frame, position)  // for exsiting and new create object
    {
        console.log("blowradius :" + this.blowradius);
        ...
        if (expectedX != null){
          ...
          console.log("Observered value :" + observeredX);
          console.log("Deviation value(before modified): " + (observeredX - expectedX[1]));
          console.log("Deviation value(after modified): " + (modifiedX - expectedX[1]));
        }
        else{
        ...
        console.log("x list :"); // ¨ú­È this.annotations[i].xtl, this.annotations[i].ytl, this.annotations[i].xbr, this.annotations[i].ybr  
